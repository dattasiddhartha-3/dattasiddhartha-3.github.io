...
Thank you for venturing into my repository of project highlights, research experience, and looking glass into my personal life. While each page or section might go in-depth into a particular domain or problem or solution, the one thing that connects them all together is that each project I work on in some way *tests* the future of that domain, to test whether the solution is in this problem's path in the coming years/decades. 2020 onwards I will be pursuing a PhD in Computer Science at the University of Oxford as a Rhodes Scholar.

<!--<a href="http://dattasiddhartha-3.github.io/#hci--products-incl-cv-nlp-mldl" class="btn btn--info">HCI</a> <a href="http://dattasiddhartha-3.github.io/#causal-inference--inductive-programming-incl-bioinformatics-networks" class="btn btn--info">inductive programming</a> <a href="http://dattasiddhartha-3.github.io/#privacy-preserving-systems-incl-obfuscation-adversarial-attacks" class="btn btn--info">privacy preserving systems</a> <a href="http://dattasiddhartha-3.github.io/#lab-contributions" class="btn btn--info">lab work</a> <a href="http://dattasiddhartha-3.github.io/#other-contributions" class="btn btn--info">other work</a>-->
...
## Causal inference / inductive programming / graphML (incl. Bioinformatics, networks)
